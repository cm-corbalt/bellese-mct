...
public class PatientSelectorAPI {
    ...
    public Group listPatientsByOrganization(
            @OperationParam(name = MctConstants.PATIENT_SELECTOR_ORG_ID_PARAM) String organizationId) {
    ...
    public Group listPatientsByFacility(
            @OperationParam(name = MctConstants.PATIENT_SELECTOR_FACILITY_IDS_PARAM) List<String> facilityIds) {
