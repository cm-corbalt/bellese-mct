...
public class GatherService {
    ...
    public Parameters gather(Group patients, List<String> facilities, String measureIdentifier, Period period) {
        ...
        result.populationReport = measureEvaluationService.getPopulationReport(
                patientDataService.getPatientReferences(), result.patientBundles);
    ...
    public static class PatientBundle {
        ...
        public void addMissingPatientData(String resourceType, Map<String, List<ValueSetInfo>> valueSetInfoMap) {
            ...
            if (valueSetInfoMap != null) {
                ...
                valueSetInfos =
                        valueSetInfoMap.values().stream().flatMap(List::stream).collect(Collectors.toList());
            }
            String details = String.format(
                    ...
                    resourceType,
                    paths,
                    valueSetInfos.stream().map(ValueSetInfo::getId).collect(Collectors.toList()));
