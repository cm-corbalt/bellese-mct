...
@SpringBootTest(
        ...
        classes = {FacilityRegistrationTest.class})
class FacilityRegistrationTest {
    ...
    void listOrganizations() {
        Bundle result = client.operation()
                .onServer()
                .named(MctConstants.LIST_ORGANIZATIONS_OPERATION_NAME)
    ...
    void listFacilities() {
        ...
        Bundle result = client.operation()
                .onServer()
                .named(MctConstants.LIST_FACILITIES_OPERATION_NAME)
        ...
        for (Bundle.BundleEntryComponent entryComponent : result.getEntry()) {
            ...
            assertEquals(
                    "Organization/acme",
                    ((Location) entryComponent.getResource())
